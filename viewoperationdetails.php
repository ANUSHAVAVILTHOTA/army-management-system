...
<br><br><br><br><br><br><br><br>
 ...
 <div id="viewoperation">
  ...
  <div id="row">
    ...
    $sql = "SELECT o.id, o.operationname, o.operationpurpose, o.startdate, o.operationdesc, o.status, o.operationassigndate, r.fullname, c.countryname, s.statename, t.teamname FROM team t, teamassign a, operation o, register r, state s, country c WHERE a.agentmailid=r.emailid AND a.teamid=t.id AND t.id=o.teamid AND c.id=o.countryid AND s.id=o.stateid AND a.agentmailid='$email' ";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<tr>";
                    ...
                    echo "<td>" . $row['teamname'] . " (<strong> Head Name :</strong> ". $row['fullname'] . " )"  . "</td>";
                    echo "<td>" . $row['startdate'] . "</td>";
                    echo "<td>" . $row['status'] . "</td>";
?>
<td>
   <button type="button" class="viewmodal btn btn-warning btn-sm" data-toggle="modal">view</button>
   <a href="editoperation12.php?id=<?php echo $row['id'] ?>" class="btn btn-info btn-sm">update</a>
   <a href="viewoperations12.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm">show</a>
</td>
<?php
