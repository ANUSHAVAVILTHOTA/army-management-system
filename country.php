...
<label class="radio-inline"><input type="radio" id="add" name="optradio"><strong class="text-success">Add Country</strong></label>
...
<?php
            if(isset($_GET['error'])==true){
                ...
                elseif($_GET['error']==3){  
                echo "<b style='color:#ff9900'>*&nbsp; Country is successfully done. </b>";       
                }
            }
            ?>
</center>            
