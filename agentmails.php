...
<label class="radio-inline"><input type="radio" id="compose" name="optradio"><strong class="text-success" style="color:#fff";>Compose Mail</strong></label>
...
<div id="composemail">
<center><h3><strong  style="color:#fff">Compose Mail</strong></h3></center>
...
<br><br>
 ...
 <div class="log">
<form method="POST" action="agentcomposeaction.php" enctype="multipart/form-data" >
...
$sql=mysqli_query($db,"SELECT t.teamlead, t.teamname, r.fullname FROM team t, teamassign a, register r WHERE a.agentmailid=r.emailid AND t.id=a.teamid AND a.agentmailid='agent@gmail.com' ");
   
while ($row=mysqli_fetch_array($sql)) { ?>

  <option value=<?php echo $row['teamlead'];?>><?php echo $row['teamname'] ." ( ". $row['fullname'] . " )" ;?></option>
  <?php } ?>
</select>
</div>
</div>
...
<!-- Start the sent mails -->
 ...
 <div id="sentmails" style="display:none">
  ...
  <div id="row">
    ...
    $sql = "SELECT * FROM mails WHERE fromid='$email' ";
...
<!-- Start the Inbox mails -->
 ...
 <div id="inboxmails" style="display:none">
  ...
  <div id="row">
    ...
    $sql = "SELECT * FROM mails WHERE toid='$email' ";
...
<td>
    <a href="agentreply.php?id=<?php echo  $row['id'] ?>" class="btn btn-warning btn-sm">Reply</a>
</td>
