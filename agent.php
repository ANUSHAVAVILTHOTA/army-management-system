...
<label class="radio-inline"><input type="radio" id="add" value="pn" name="optradio"><strong class="text-success">Add Agent</strong></label>
<label class="radio-inline"><input type="radio" id="view" value="pn" name="optradio"><strong class="text-danger">View Agents</strong></label>
   </center>    
 </div>
</div>

<div id="addagent">
<center><h3><strong>Agent Registration</strong></h3>
...
<form method="POST" action="agentaction.php" enctype="multipart/form-data" >
...
<div class="row btngrp">
 ...
 <div id="viewagent" style="display:none">
  ...
  <div id="row">
        ...
        <div class="panel panel-primary filterable">
                <div class="panel-heading"><center><h3 class="panel-title">Agent Details</h3></center>
