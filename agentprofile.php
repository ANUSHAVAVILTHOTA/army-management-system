...
<center>
<h4  style="color:#fff">Change <strong style="color:red"><?php echo $emailid=$_SESSION['emailid']; ?></strong> Details</h4>
<?php
...
<div class=""> 
<form method="post" action="agentprofileaction.php" enctype="multipart/form-data">
