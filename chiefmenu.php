...
echo date("d F, Y") ;  ?></strong></p>
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="chiefhome.php">Home</a>
                </li>
                <li>
                    <a href="agent.php">Agents</a>
                </li>
                <li>
                    <a href="viewoperations.php">Operations</a>
                </li>
                <li>
                    <a href="viewteam.php">Team</a>
                </li>
                <li>
                    <a href="viewweapons.php">Weapons</a>
                </li>
                <li>
                    <a href="weaponsassign.php">Assign Weapons</a>
                </li>
                <li>
                    <a href="chiefmails.php">Mails</a>
                </li>
                <li>
                    <a href="chiefprofile.php">Profile</a>
                </li>
                <!-- <li>
