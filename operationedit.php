...
<div class=""> 
<form method="post" action="operationeditaction.php" enctype="multipart/form-data">
...
<div class="row">
      <div class="col-xs-12 col-sm-5 form-group">
        ...
        <div class="input-group">
        <span class="input-group-addon"><i class ="fa fa-user"></i></span>
      <input type="text" class="form-control" id="startdate" placeholder="Start Date" name="startdate" value='<?php echo $row['startdate'] ?>' required>
          </div>
      </div>
...
$sql2=mysqli_query($db, "SELECT * FROM team ");
while ($row2 = mysqli_fetch_array($sql2)){
  ?>
          <option value="<?php echo $row2['id']; ?>"><?php echo $row2['teamname']; ?></option>
<?php } ?>  
      </select>
     </div>
   </div> 
...
<div class="row">
  <div class="col-xs-12 col-sm-10 form-group">
    ...
    <textarea class="form-control" rows="3" id="operationdesc" name="operationdesc" placeholder="Describe about the operation details in 4000 words." readonly><?php echo $row['operationdesc']; ?></textarea> 
  </div> 
</div>        
</div>
